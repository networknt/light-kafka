...
public class SchemaManagerImplTest {
    ...
    public void getSchema_avro_schemaId() throws Exception {
        ...
        Assertions.assertEquals(new RegisteredSchema(KEY_SUBJECT, schemaId, schemaVersion, schema), actual);
    }
    ...
    public void getSchema_avro_schemaId_subject() throws Exception {
        ...
        Assertions.assertEquals(new RegisteredSchema(subject, schemaId, schemaVersion, schema), actual);
    }
    ...
    public void getSchema_avro_latestSchema_notIsKey() throws Exception {
        ...
        Assertions.assertEquals(new RegisteredSchema(VALUE_SUBJECT, schemaId, schemaVersion, schema), actual);
    }
